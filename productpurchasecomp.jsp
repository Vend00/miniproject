...
<body>
    ...
    <!-- preloader area start -->
        ...
        <div class="page-container">
                        ...
                        <nav>
                            <ul class="metismenu" id="menu">
                                ...
                                <li>
                                    ...
                                    <ul class="collapse">
                                        <li><a href="productpurchasecomp.jsp">New Order</a></li>
                                        <li><a href="linechart.html">Previous Orders</a></li>
                                ...
                                <li>
                                    ...
                                    <ul class="collapse">
                                        <li><a href="barchart.html">Accepted</a></li>
                                        <li><a href="linechart.html">In Process</a></li>
                                        <li><a href="piechart.html">Rejected</a></li>
                                    </ul>
                                </li>
                                <li>
                            ...
                            <div class="search-box pull-left">
                                <form action="#">
                                   <!--input type="text" name="search" placeholder="Search..." required>
                                    <i-- class="ti-search"></i-->
                                    <h2><span id="Welcome">New Purchase</span></h2>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="breadcrumbs-area clearfix">
                                <h4 class="page-title pull-left">New Order</h4>
                                <ul class="breadcrumbs pull-left">
                                    <li><a href="userfront.html">User</a></li>
                        ...
                        <div class="col-sm-6 clearfix">
                            <div class="user-profile pull-right">
                                ...
                                <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Computer Department<i class="fa fa-angle-down"></i></h4>
            ...
            <center>
<form action="createordercomp.jsp" method="post">
