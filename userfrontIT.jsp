<%-- 
    Document   : userfrontIT
    Created on : 5 Oct, 2019, 10:30:59 AM
    Author     : piyush
--%>
...
String sql = "SELECT budget FROM department where dname='Information Technology'";
...
Class.forName("com.mysql.jdbc.Driver");
Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/miniproject","root","piyush123");
String sql = "SELECT loginid FROM login where dept='Information Technology'";
PreparedStatement ps = con.prepareStatement(sql);
ResultSet rs = ps.executeQuery(); 
if(rs.next())
{
