<%-- 
    Document   : userfrontcomp
    Created on : 5 Oct, 2019, 10:32:14 AM
    Author     : piyush
--%>
...
String sql = "SELECT budget FROM department where dname='Computer'";
                        ...
                        <div class="search-box pull-left">
                            <form action="#">
                               <!--input type="text" name="search" placeholder="Search..." required>
                                <i-- class="ti-search"></i-->
                                <h2><span id="Welcome">Welcome User!!!</span></h2>
                            </form>
                        </div>
                    </div>
...
Class.forName("com.mysql.jdbc.Driver");
Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/miniproject","root","piyush123");
String sql = "SELECT loginid FROM login where dept='Computer'";
PreparedStatement ps = con.prepareStatement(sql);
ResultSet rs = ps.executeQuery(); 
if(rs.next())
{
