    ...
    <div class="page-container">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="allocatebudget.html" aria-expanded="true"><i class="ti-layout-sidebar-left"></i><span>Allocate Budget
                                    </span></a>
                            </li>
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="linechart.html">Update Product</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="barchart.html">New User</a></li>
                                    <li><a href="linechart.html">Update User</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="fontawesome.html">New Vendor</a></li>
                                    <li><a href="fontawesome.html">Update Vendor</a></li>
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-table"></i>
                                    <span>Orders</span></a>
                                <ul class="collapse">
                                    <li><a href="table-basic.html">Ongoing Order</a></li>
                                    <li><a href="table-layout.html">Previous Orders</a></li>
                                </ul>
                            </li>
        ...
        <div class="main-content">
                    ...
                    <div class="col-md-6 col-sm-8 clearfix">
                        ...
                        <div class="search-box pull-left">
                            <form action="#">
                                ...
                                <i-- class="ti-search"></i-->
                                <h2><span id="Welcome">Add New Vendor</span></h2>
                            </form>
                        </div>
                    </div> 
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Darshan Bhamare <i class="fa fa-angle-down"></i></h4>
            ...
            <div class="main-content-inner">
                <center>
                    <form action="addvendor.jsp" method="post">
            ...
            <div>
                            ...
                            <p><td>Product Price:</td>
                                <td>
                            <input type="number" name="proprice" min="0">
                        </td>
                        </p>
                            </tr>
                        </div>
